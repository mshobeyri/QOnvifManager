...
public:
    ...
    void getDeviceInterfaces(QString _deviceEndPointAddress);
    void getDeviceProtocols(QString _deviceEndPointAddress);
    void getDeviceDefaultGateway(QString _deviceEndPointAddress);
    void getDeviceDiscoveryMode(QString _deviceEndPointAddress);
    void getDeviceDNS(QString _deviceEndPointAddress);
    void getDeviceHostname(QString _deviceEndPointAddress);
    void getDeviceNTP(QString _deviceEndPointAddress);

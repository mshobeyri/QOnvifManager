...
class Node : public QObject
{
    ...
    Q_PROPERTY(QString absolutePanTiltPositionSpaceUri READ
                   absolutePanTiltPositionSpaceUri WRITE
                                                   setAbsolutePanTiltPositionSpaceUri)
    Q_PROPERTY(float absolutePanTiltPositionSpaceXRangeMin READ
                   absolutePanTiltPositionSpaceXRangeMin WRITE
                                                         setAbsolutePanTiltPositionSpaceXRangeMin)
    Q_PROPERTY(float absolutePanTiltPositionSpaceXRangeMax READ
                   absolutePanTiltPositionSpaceXRangeMax WRITE
                                                         setAbsolutePanTiltPositionSpaceXRangeMax)
    Q_PROPERTY(float absolutePanTiltPositionSpaceYRangeMin READ
                   absolutePanTiltPositionSpaceYRangeMin WRITE
                                                         setAbsolutePanTiltPositionSpaceYRangeMin)
    Q_PROPERTY(float absolutePanTiltPositionSpaceYRangeMax READ
                   absolutePanTiltPositionSpaceYRangeMax WRITE
                                                         setAbsolutePanTiltPositionSpaceYRangeMax)
    Q_PROPERTY(
        QString absoluteZoomPositionSpaceUri READ absoluteZoomPositionSpaceUri
            WRITE setAbsoluteZoomPositionSpaceUri)
    Q_PROPERTY(float absoluteZoomPositionSpaceXRangeMin READ
                   absoluteZoomPositionSpaceXRangeMin WRITE
                                                      setAbsoluteZoomPositionSpaceXRangeMin)
    Q_PROPERTY(float absoluteZoomPositionSpaceXRangeMax READ
                   absoluteZoomPositionSpaceXRangeMax WRITE
                                                      setAbsoluteZoomPositionSpaceXRangeMax)
    Q_PROPERTY(QString relativePanTiltTranslationSpaceUri READ
                   relativePanTiltTranslationSpaceUri WRITE
                                                      setRelativePanTiltTranslationSpaceUri)
    Q_PROPERTY(float relativePanTiltTranslationSpaceXRangeMin READ
                   relativePanTiltTranslationSpaceXRangeMin WRITE
                                                            setRelativePanTiltTranslationSpaceXRangeMin)
    Q_PROPERTY(float relativePanTiltTranslationSpaceXRangeMax READ
                   relativePanTiltTranslationSpaceXRangeMax WRITE
                                                            setRelativePanTiltTranslationSpaceXRangeMax)
    Q_PROPERTY(float relativePanTiltTranslationSpaceYRangeMin READ
                   relativePanTiltTranslationSpaceYRangeMin WRITE
                                                            setRelativePanTiltTranslationSpaceYRangeMin)
    Q_PROPERTY(float relativePanTiltTranslationSpaceYRangeMax READ
                   relativePanTiltTranslationSpaceYRangeMax WRITE
                                                            setRelativePanTiltTranslationSpaceYRangeMax)
    Q_PROPERTY(QString relativeZoomTranslationSpaceUri READ
                   relativeZoomTranslationSpaceUri WRITE
                                                   setRelativeZoomTranslationSpaceUri)
    Q_PROPERTY(float relativeZoomTranslationSpaceXRangeMin READ
                   relativeZoomTranslationSpaceXRangeMin WRITE
                                                         setRelativeZoomTranslationSpaceXRangeMin)
    Q_PROPERTY(float relativeZoomTranslationSpaceXRangeMax READ
                   relativeZoomTranslationSpaceXRangeMax WRITE
                                                         setRelativeZoomTranslationSpaceXRangeMax)
    Q_PROPERTY(
        QString continuousPanTiltVelocityUri READ continuousPanTiltVelocityUri
            WRITE setContinuousPanTiltVelocityUri)
    Q_PROPERTY(float continuousPanTiltVelocityXRangeMin READ
                   continuousPanTiltVelocityXRangeMin WRITE
                                                      setContinuousPanTiltVelocityXRangeMin)
    Q_PROPERTY(float continuousPanTiltVelocityXRangeMax READ
                   continuousPanTiltVelocityXRangeMax WRITE
                                                      setContinuousPanTiltVelocityXRangeMax)
    Q_PROPERTY(float continuousPanTiltVelocityYRangeMin READ
                   continuousPanTiltVelocityYRangeMin WRITE
                                                      setContinuousPanTiltVelocityYRangeMin)
    Q_PROPERTY(float continuousPanTiltVelocityYRangeMax READ
                   continuousPanTiltVelocityYRangeMax WRITE
                                                      setContinuousPanTiltVelocityYRangeMax)
    Q_PROPERTY(QString continuousZoomVelocitySpaceUri READ
                   continuousZoomVelocitySpaceUri WRITE
                                                  setContinuousZoomVelocitySpaceUri)
    Q_PROPERTY(float continuousZoomVelocitySpaceXRangeMin READ
                   continuousZoomVelocitySpaceXRangeMin WRITE
                                                        setContinuousZoomVelocitySpaceXRangeMin)
    Q_PROPERTY(float continuousZoomVelocitySpaceXRangeMax READ
                   continuousZoomVelocitySpaceXRangeMax WRITE
                                                        setContinuousZoomVelocitySpaceXRangeMax)
    Q_PROPERTY(QString panTiltSpeedSpaceUri READ panTiltSpeedSpaceUri WRITE
                                                                      setPanTiltSpeedSpaceUri)
    Q_PROPERTY(float panTiltSpeedSpaceXRangeMin READ panTiltSpeedSpaceXRangeMin
                   WRITE setPanTiltSpeedSpaceXRangeMin)
    Q_PROPERTY(float panTiltSpeedSpaceXRangeMax READ panTiltSpeedSpaceXRangeMax
                   WRITE setPanTiltSpeedSpaceXRangeMax)
    Q_PROPERTY(QString zoomSpeedSpaceUri READ zoomSpeedSpaceUri WRITE
                                                                setZoomSpeedSpaceUri)
    Q_PROPERTY(float zoomSpeedSpaceXRangeMin READ zoomSpeedSpaceXRangeMin WRITE
                                                                          setZoomSpeedSpaceXRangeMin)
    Q_PROPERTY(float zoomSpeedSpaceXRangeMax READ zoomSpeedSpaceXRangeMax WRITE
                                                                          setZoomSpeedSpaceXRangeMax)
    Q_PROPERTY(int maximumNumberOfPresets READ maximumNumberOfPresets WRITE
                                                                      setMaximumNumberOfPresets)

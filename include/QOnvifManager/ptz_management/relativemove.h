...
class RelativeMove : public QObject
{
    ...
    Q_PROPERTY(float translationPanTiltX READ translationPanTiltX WRITE
                                                                  setTranslationPanTiltX)
    Q_PROPERTY(float translationPanTiltY READ translationPanTiltY WRITE
                                                                  setTranslationPanTiltY)
    Q_PROPERTY(QString translationPanTiltSpace READ translationPanTiltSpace
                   WRITE setTranslationPanTiltSpace)
    Q_PROPERTY(
        float translationZoomX READ translationZoomX WRITE setTranslationZoomX)
    Q_PROPERTY(QString translationZoomSpace READ translationZoomSpace WRITE
                                                                      setTranslationZoomSpace)
    ...
    Q_PROPERTY(QString speedPanTiltSpace READ speedPanTiltSpace WRITE
                                                                speedPanTiltSpace)
    Q_PROPERTY(float speedZoomX READ speedZoomX WRITE setSpeedZoomX)
    Q_PROPERTY(
        QString speedZoomSpace READ speedZoomSpace WRITE setSpeedZoomSpace)

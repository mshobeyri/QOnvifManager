...
{
    Q_OBJECT
    Q_PROPERTY(QString ptzConfigurationToken READ ptzConfigurationToken WRITE
                                                                        setPtzConfigurationToken)
    ...
    // Q_PROPERTY(QString defaultAbsolutePantTiltPositionSpace READ
    // defaultAbsolutePantTiltPositionSpace WRITE
    // setDefaultAbsolutePanTiltPositionSpace)
    Q_PROPERTY(QString defaultAbsoluteZoomPositionSpace READ
                   defaultAbsoluteZoomPositionSpace WRITE
                                                    setDefaultAbsoluteZoomPositionSpace)
    Q_PROPERTY(QString defaultRelativePanTiltTranslationSpace READ
                   defaultRelativePanTiltTranslationSpace WRITE
                                                          setDefaultRelativePanTiltTranslationSpace)
    Q_PROPERTY(QString defaultRelativeZoomTranslationSpace READ
                   defaultRelativeZoomTranslationSpace WRITE
                                                       setDefaultRelativeZoomTranslationSpace)
    Q_PROPERTY(QString defaultContinuousPanTiltVelocitySpace READ
                   defaultContinuousPanTiltVelocitySpace WRITE
                                                         setDefaultContinuousPanTiltVelocitySpace)
    Q_PROPERTY(QString defaultContinuousZoomVelocitySpace READ
                   defaultContinuousZoomVelocitySpace WRITE
                                                      setDefaultContinuousZoomVelocitySpace)
    ...
    Q_PROPERTY(QString defaultPTZTimeout READ defaultPTZTimeout WRITE
                                                                setDefaultPTZTimeout)
    Q_PROPERTY(QString panTiltUri READ panTiltUri WRITE setPanTiltUri)
    Q_PROPERTY(
        float panTiltXRangeMin READ panTiltXRangeMin WRITE setPanTiltXRangeMin)
    Q_PROPERTY(
        float panTiltXRangeMax READ panTiltXRangeMax WRITE setPanTiltXRangeMax)
    Q_PROPERTY(
        float panTiltYRangeMin READ panTiltYRangeMin WRITE setPanTiltYRangeMin)
    Q_PROPERTY(
        float panTiltYRangeMax READ panTiltYRangeMax WRITE setPanTiltYRangeMax)

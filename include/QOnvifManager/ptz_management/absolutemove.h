...
class AbsoluteMove : public QObject
{
    ...
    Q_PROPERTY(
        float positionPanTiltX READ positionPanTiltX WRITE setPositionPanTiltX)
    Q_PROPERTY(
        float positionPanTiltY READ positionPanTiltY WRITE setPositionPanTiltY)
    Q_PROPERTY(QString positionPanTiltSpace READ positionPanTiltSpace WRITE
                                                                      setPositionPanTiltSpace)
    Q_PROPERTY(float positionZoomX READ positionZoomX WRITE setPositionZoomX)
    Q_PROPERTY(QString positionZoomSpace READ positionZoomSpace WRITE
                                                                setPositionZoomSpace)

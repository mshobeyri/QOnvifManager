...
public:
    ...
    void setDefaultAbsolutePantTiltPositionSpace(
        QString defaultAbsolutePantTiltPositionSpace) {
        m_defaultAbsolutePantTiltPositionSpace.push_back(
    ...
    void setDefaultAbsoluteZoomPositionSpace(
        QString defaultAbsoluteZoomPositionSpace) {
        m_defaultAbsoluteZoomPositionSpace.push_back(
    ...
    void setDefaultRelativePanTiltTranslationSpace(
        QString defaultRelativePanTiltTranslationSpace) {
        m_defaultRelativePanTiltTranslationSpace.push_back(
    ...
    void setDefaultRelativeZoomTranslationSpace(
        QString defaultRelativeZoomTranslationSpace) {
        m_defaultRelativeZoomTranslationSpace.push_back(
    ...
    void setDefaultContinuousPanTiltVelocitySpace(
        QString defaultContinuousPanTiltVelocitySpace) {
        m_defaultContinuousPanTiltVelocitySpace.push_back(
    ...
    void setDefaultContinuousZoomVelocitySpace(
        QString defaultContinuousZoomVelocitySpace) {
        m_defaultContinuousZoomVelocitySpace.push_back(

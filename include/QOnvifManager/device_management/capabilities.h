...
class Capabilities : public QObject
{
    ...
    Q_PROPERTY(bool zeroConfiguration READ zeroConfiguration WRITE
    ...
    Q_PROPERTY(
        bool discoveryResolve READ discoveryResolve WRITE setDiscoveryResolve)
    Q_PROPERTY(bool discoveryBye READ discoveryBye WRITE setDiscoveryBye)
    Q_PROPERTY(
        bool remoteDiscovery READ remoteDiscovery WRITE setRemoteDiscovery)
    ...
    Q_PROPERTY(
        bool firmwareUpgrade READ firmwareUpgrade WRITE setFirmwareUpgrade)
    Q_PROPERTY(int major READ major WRITE setMajor)
    Q_PROPERTY(bool minor READ minor WRITE setMinor)
    Q_PROPERTY(bool httpFirmwareUpgrade READ httpFirmwareUpgrade WRITE
                                                                 setHttpFrimwareUpgrade)
    Q_PROPERTY(
        bool httpSystemBackup READ httpSystemBackup WRITE setHttpSystemBackup)
    Q_PROPERTY(bool httpSystemLogging READ httpSystemLogging WRITE
                                                             setHttpSystemLogging)
    Q_PROPERTY(bool httpSupportInformation READ httpSupportInformation WRITE
                                                                       setHttpSupportInformation)
    Q_PROPERTY(
    ...
    Q_PROPERTY(bool remoteUserHanding READ remoteUserHanding WRITE
                                                             setRemoteUserHanding)

...
class NetworkInterfaces : public QObject
{
    ...
    Q_PROPERTY(bool networkInfacesEnabled READ networkInfacesEnabled WRITE
                                                                     setNetworkInfacesEnabled)
    Q_PROPERTY(
        bool autoNegotiation READ autoNegotiation WRITE setAutoNegotiation)
    ...
    Q_PROPERTY(QString ipv4ManualAddress READ ipv4ManualAddress WRITE
    ...
    Q_PROPERTY(QString ipv4LinkLocalAddress READ ipv4LinkLocalAddress WRITE
                                                                      setIpv4LinkLocalAddress)
    Q_PROPERTY(int ipvLinkLocalPrefixLength READ ipvLinkLocalPrefixLength WRITE
                                                                          setIpvLinkLocalPrefixLength)
    Q_PROPERTY(QString ipv4FromDHCPAddress READ ipv4FromDHCPAddress WRITE

...
class StreamUri : public QObject
{
    ...
    Q_PROPERTY(bool invalidAfterConnect READ invalidAfterConnect WRITE
                                                                 setInvalidAfterConnect)
    Q_PROPERTY(bool invalidAfterReboot READ invalidAfterReboot WRITE
                                                               setInvalidAfterReboot)
